...
from .models import BothRewriteResult, ParseFailureMode, XrefMappings
...
def apply_post(
    ...
    *,
    ...
    if target.target is TargetId.SPARK_SQL:
        ...
        return rewrite_sql_paths(output, mappings.by_path)
...
__all__ = ["apply_both", "apply_post", "apply_pre"]
